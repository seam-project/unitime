...
//	String propertyParentClass();
	...
	@DefaultMessage("Search/Display Instructors (Alt+{0})")
	String titleSearchStudents(String accessKey);
	...
	@DefaultMessage("No students were found.")
	String errorNoStudentsFoundInSearch();
